...
static LONG WINAPI rd_crash_filter(EXCEPTION_POINTERS* ep)
{
    ...
    fprintf(stderr, "[CRASH] module=%p rva=0x%llX  (llvm-symbolizer --obj=rubberducky.exe 0x%llX)\n",
...
static void rd_abort_handler(int)
{
...
{
    int rsx_ok = (rsx_d3d12_backend_init(1280, 720, "Rubber Ducky Tech Demo (ps3recomp)") == 0);
...
#pragma comment(lib, "winmm.lib")
    ...
    SetUnhandledExceptionFilter(rd_crash_filter);
    ...
    signal(SIGABRT, rd_abort_handler);
